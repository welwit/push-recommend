...
#ifndef RECOMMENDATION_NEWS_RANKER_RANKING_HANDLER_H_
#define RECOMMENDATION_NEWS_RANKER_RANKING_HANDLER_H_
...
#endif  // RECOMMENDATION_NEWS_RANKER_RANKING_HANDLER_H_
